          ...
          <nav class="menu-area d-lg-flex align-items-center ml-auto">
            <ul>
              ...
              <li>
                ...
                <ul>
                  <li>
                    <router-link to="/ethics">Ethics And Policies</router-link>
                  </li>
                  <!-- <li><router-link to="/blogs">BLOGS</router-link></li> -->
                  <li>
                    <router-link to="/aim-and-scope">Aim And Scope</router-link>
                  </li>
                  <li>
                    <router-link to="/editorial-board">Editorial Board</router-link>
                  </li>
                  <li>
                    <router-link to="/peer-review-policy">Peer Review Policy</router-link>
                  </li>
                  <li>
                    <router-link to="/publication-ethics-policy">Publication Ethics Policy</router-link>
                  </li>
                  <li>
                    <router-link to="/indexing-and-abstracting">Indexing And Abstracting</router-link>
                  </li>
              ...
              <li>
                <a href="javascript:void(0)">For Authors <b-icon-arrow-down></b-icon-arrow-down></a>
                ...
                <ul>
                  ...
                  <li>
                    <router-link to="/instruction-for-author">Instruction For Author</router-link>
                  </li>
                  <li>
                    <a href="http://editorial.fdrpjournals.org/login?journal=3">Manuscript Submission</a>
                  ...
                  <li>
                    <router-link to="/article-processing-charges">Article Processing Charges</router-link>
                  </li>
                  <li><router-link to="/downloads">Downloads</router-link></li>
                  <li>
                    <router-link to="/copyright-form">Copyright Form</router-link>
                  </li>
                  <li>
                    <router-link to="/paper-status">Paper Status</router-link>
                  </li>
                </ul>
              </li>
              <li><router-link to="/blogs">Blogs</router-link></li>
      ...
      <transition enter-active-class="animate__animated animate__fadeInLeft"
        ...
        <div class="mobile-menu-area" v-show="mobileMenu">
          ...
          <div class="mobile-menu-components" style="width: 100vw;">
            ...
            <nav class="mobile-menu mx-auto" style="width: 100vw;">
              <ul >
                <li>
                  <router-link to="/">Home</router-link>
                </li>
