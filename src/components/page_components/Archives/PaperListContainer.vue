<template>
  <div class="paperlist-container" v-if="listVisible && !paperPage">
    ...
    <div class="row paperBox mb-3" v-for="paper in papersList" :key="paper.paper_uniqueid">
      ...
      <div class="col-3 p-1 py-3">
        <b-button class="col-12" variant="outline-primary" size="sm" :href="'paper-details?paperid=' +
          paper.paper_id +
          '&papertitle=' +
        ...
        <b-button class="col-12 my-2 "  variant="outline-primary" size="sm" @click="downloadPDF(paper.paper_url)">Download
          PDF</b-button>
